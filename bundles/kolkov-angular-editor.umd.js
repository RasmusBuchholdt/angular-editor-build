(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.kolkov = global.kolkov || {}, global.kolkov['angular-editor'] = {}), global.ng.core, global.ng.common.http, global.ng.common, global.ng.forms, global.ng.platformBrowser));
        ...
        AngularEditorToolbarComponent.prototype.onFileChanged = function (event) {
            ...
            if (file.type.includes('image/')) {
                if (this.upload) {
                    ...
                    this.editorService.uploadImage(file).subscribe(function (response) {
                        // @ts-ignore
                        if (response.body) {
                            // @ts-ignore
                            _this.watchUploadImage(response, event);
                        }
                    });
                }
                else {
